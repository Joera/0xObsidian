...
// import * as po from '../../hardhat/artifacts/contracts/Pod.sol/Pod.json' assert { type: "json" };
...
// const podContract = po as unknown as PodContract;
...
//                 const abi = podContract.abi;
//                 const functionAbi  = abi.find((item: any) => item.name === "getReaders" && item.type === 'function');
...
//                 if (file != null) {
//                     await this.main.plugin.app.fileManager.processFrontMatter( file, (frontmatter: any) => {
